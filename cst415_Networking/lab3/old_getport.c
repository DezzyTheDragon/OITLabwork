...
{
    return do_request(service_name, MSG_TYPE_REQUEST_PORT, 0);
}
//*************************************************
// Thread safety: None
int lookup_port(const char *service_name)
{
    return do_request(service_name, MSG_TYPE_LOOKUP_PORT, 0);
}
//*************************************************
// Thread safety: None
int release_port(const char *service_name, int port)
{
    return do_request(service_name, MSG_TYPE_CLOSE_PORT, port);
}
//*************************************************
// Thread safety: None
int keep_alive_port(const char *service_name, int port)
{
    return do_request(service_name, MSG_TYPE_KEEP_ALIVE, port);
}
